      ...
      {!preview ? (
        ...
        >
          ...
          <div className="text-5xl mb-3">
            {compressing ? (
              <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="inline-block" aria-hidden="true">
                <path d="M5 22h14"/>
                <path d="M5 2h14"/>
